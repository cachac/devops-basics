...
> 7kknqriqj4co727ou3cuqe2veaq3rpgywpyefcnhm6l73t6juwyq
...
- CICD
- Name: appVariable
- Value: { "APP_NAME":"backend", "NODE_ENV":"qa", "NODE_PORT":"3000", "TOKEN_LIMIT":"7d", "TOKEN_SECRET":"PASS", "PRIVATE_API": "http://localhost:3002/private" }
...
- Pipelines
  ...
  - Workload Identity federation (automatic)
	- seleccionar la suscripción y RG
	- Service connection name: cicd
...
- Access control (IAM)
- Add role assignment
- Seleccionar Key vault administrator
- Siguiente y seleccionar la cuenta

## 4.2. Create key vault
- nombre: estudiante
- Create
- Objects - Secrets - Generate
- Name: appVariable
- Value:
